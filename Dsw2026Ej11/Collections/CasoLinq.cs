...
public class CasoLinq
{
    ...
    {
        return libros.Select(l => $"Titulo: {l.Titulo} - Precio:{l.Precio:C}").ToList();
    }
    ...
    {
        return libros.Where(l => l.Precio >  GetPromedioPrecios()).ToList();
    }

    public List<Libro> LibrosTitulos()
    {
